    ...
    <div className="space-y-6">
      <div className="relative overflow-hidden rounded-2xl border border-brand-200 bg-gradient-to-br from-brand-100 via-brand-50 to-white p-6 shadow-card sm:p-8">
        ...
        <div className="relative">
          <div className="mb-2 inline-flex items-center gap-2 rounded-full bg-brand-gradient px-3 py-1 text-xs font-semibold text-white shadow-sm"><Briefcase size={14} /> Company Supervisor</div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Link to="/openings" className="block hover-lift"><StatCard icon={Briefcase} tone="accent" label="Open postings" value={stats.open_openings} sub="OJT openings" /></Link>
        <Link to="/openings" className="block hover-lift"><StatCard icon={UserPlus} tone="emerald" label="New applicants" value={stats.new_applicants} sub="to review" /></Link>
        <Link to="/attendance" className="block hover-lift"><StatCard icon={CalendarClock} tone="amber" label="Pending attendance" value={stats.pending_attendance} sub="awaiting approval" /></Link>
        <Link to="/weekly-reports" className="block hover-lift"><StatCard icon={FileText} tone="rose" label="Pending reports" value={stats.pending_reports} sub="to review" /></Link>
