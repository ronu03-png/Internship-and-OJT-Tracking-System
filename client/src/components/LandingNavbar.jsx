    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <Link to="/login" className={`rounded-lg px-4 py-2 text-sm font-semibold transition ${scrolled ? "text-slate-600 hover:bg-slate-100" : "text-slate-700 hover:bg-white/50"}`}>Get Started</Link>
          <Link to="/login" className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-blue-200 transition hover:bg-blue-700 hover:scale-105">Get Started</Link>
        </div>
        ...
        <div className="border-b border-slate-200 bg-white/95 px-4 py-4 backdrop-blur-md">
          <nav className="flex flex-col gap-2">
            ...
            <div className="mt-2 flex flex-col gap-2 border-t border-slate-100 pt-3">
              <Link to="/login" onClick={() => setMobileOpen(false)} className="rounded-lg px-3 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-100">Get Started</Link>
              <Link to="/login" onClick={() => setMobileOpen(false)} className="rounded-lg bg-blue-600 px-3 py-2 text-sm font-semibold text-white text-center hover:bg-blue-700">Get Started</Link>
            </div>
          </nav>
        </div>
      </div>
